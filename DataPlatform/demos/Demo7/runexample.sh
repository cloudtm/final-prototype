...
cd ${WORKING_DIR}
MAVEN_OPTS="-Xmx1G" mvn clean package exec:java -Dcode.generator=$BACKEND -DskipTests -Djava.net.preferIPv4Stack=true -Dlog4j.configuration=file:/home/cloudtm/DataPlatform/examples/scenario7/src/main/resources/log4j.properties -DbtreeLowerBound=16 -Dexec.mainClass="test.MainApp" $ARGS
exit 0
